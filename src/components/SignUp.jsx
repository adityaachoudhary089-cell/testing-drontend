...
import { Eye, EyeOff, Terminal, ArrowLeft, User, Mail, Lock, Loader2, CheckCircle } from 'lucide-react';
...
export function SignUp({ onBack, onSignIn }) {
  ...
  const handlePasswordChange = (e) => {
    ...
    } else if (formData.confirmPassword && password === formData.confirmPassword) {
      setConfirmError('');
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    // CHECK 2: Strong Password validation
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute top-32 right-20 w-28 h-28 border border-primary/10 rotate-12"
        initial={{ rotate: 12, scale: 0, opacity: 0 }}
        animate={{ rotate: 192, scale: 1, opacity: 0.3 }}
        transition={{ duration: 2.5, ease: "easeOut" }}
      />

      <motion.div
        className="absolute bottom-32 left-16 w-20 h-20 rounded-full border border-primary/10"
        ...
        >
          ...
          <Card className="relative bg-card/60 backdrop-blur-2xl border border-white/20 shadow-2xl shadow-black/10 overflow-hidden">
            ...
            <CardHeader className="text-center space-y-4 relative z-10">
              ...
              >
                <CardTitle className="text-2xl">Join Linux</CardTitle>
                ...
                {!isLoading && !isSuccess ? (
                  ...
                  >
                    ...
                    >
                      ...
                      <motion.div className="relative" whileFocus={{ scale: 1.02 }}>
                        ...
                        <Input
                          ...
                          className="bg-input-background/80 backdrop-blur-sm border-border/50 focus:border-primary/50 transition-all duration-300 pl-10"
                          required
                        />
                      </motion.div>
                    </motion.div>
                    ...
                    >
                      ...
                      <motion.div className="relative" whileFocus={{ scale: 1.02 }}>
                        ...
                        <Input
                          ...
                          className="bg-input-background/80 backdrop-blur-sm border-border/50 focus:border-primary/50 transition-all duration-300 pl-10 pr-10"
                          required
                        />
                        <Button
                          type="button"
                      ...
                      {passwordError && (
                        <p className="text-xs text-red-500 mt-1 px-2">{passwordError}</p>
                      )}
                    </motion.div>
                    ...
                    >
                      ...
                      {/* ADD THIS ERROR MESSAGE */}
                      {confirmError && (
                        <p className="text-xs text-red-500 mt-1 px-2">{confirmError}</p>
                      )}
                    </motion.div>
                    ...
                    {/* error message */}
                    {/* Add this after your terms and conditions section */}
                    {formError && (
                      <motion.div
                    ...
                    >
                      <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
                        <Button
                          ...
                          className="w-full bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary hover:shadow-xl hover:shadow-primary/25 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                        >
                          Create Account
                        </Button>
                      </motion.div>
